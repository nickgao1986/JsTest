...
describe('layui', function () {
  ...
  describe('layer.router', function () {
    var defaultData = {
      path: [],
      search: {},
      hash: ''
    ...
    it('router hash', function () {
      expect(layui.router('#/name#layer')).to.deep.equal($.extend({}, defaultData, {
        hash: '#layer',
        path: ['name'],
        href: '/name#layer'
      }));
      expect(layui.router('#/name#layer').hash).to.equal('#layer');
      expect(layui.router('#/name#layer=1').hash).to.equal('#layer=1');
      expect(layui.router('#/name##layer').hash).to.equal('##layer');
      expect(layui.router('#/name=1#layer').hash).to.equal('#layer');
      expect(layui.router('#/name=1/b=2#layer').hash).to.equal('#layer');
    });
  ...
  describe('layer.img', function () {
    ...
    //   layer.img('https://www.baidu.com/img/bd_logo1.png', function (img) {
    //     expect(img).to.not.undefined;
    //     done();
    //   });
    // });
    ...
    //   layer.img('http://www.404.xx/logo.404.gif', function () {}, function (e) {
    //     expect(e).to.not.undefined;
    //     done();
    //   });
    // });
  ...
  describe('layer.onevent', function () {
  ...
  it('layer.device', function () {
    ...
    expect(layui.device('layer.com')['layer.com']).to.be.false;
  });

  describe('layer.getStyle', function () {
