...
layui.define('layer' , function(exports){
  ...
  //字符常量
  ,MOD_NAME = 'upload', ELEM = '.layer-upload', THIS = 'layer-this', SHOW = 'layer-show', HIDE = 'layer-hide', DISABLED = 'layer-disabled'
  
  ,ELEM_FILE = 'layer-upload-file', ELEM_FORM = 'layer-upload-form', ELEM_IFRAME = 'layer-upload-iframe', ELEM_CHOOSE = 'layer-upload-choose', ELEM_DRAG = 'layer-upload-drag'
  ...
  Class.prototype.file = function(){
    ...
    if(device.ie && device.ie < 10){
      options.elem.wrap('<div class="layer-upload-wrap"></div>');
    }
  ...
  Class.prototype.events = function(){
    ...
    ,setChooseText = function(files, filename){
      ...
      elemFile.after('<span class="layer-inline '+ ELEM_CHOOSE +'">'+ value +'</span>');
    };
