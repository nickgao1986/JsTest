...
layui.define('jquery', function(exports){
  ...
  ,ELEM_MORE = 'layer-flow-more'
  ,ELEM_LOAD = '<i class="layer-anim layer-anim-rotate layer-anim-loop layer-icon ">&#xe63e;</i>';
  ...
  Flow.prototype.load = function(options){
    ...
    ,more = $('<div class="layer-flow-more"><a href="javascript:;">'+ ELEM_TEXT +'</a></div>');
    
    if(!elem.find('.layer-flow-more')[0]){
      elem.append(more);
    }
